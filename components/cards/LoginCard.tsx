...
import { loginUserHandler } from "../../app/action_layer/auth_action";
...
const LoginCard: React.FC<LoginCardProps> = (props) => {
    ...
    const handleSubmit = async (values: any) => {
        await loginUserHandler(values).then((response) =>{
            // console.log(response)
            route.push('/web/dashboard');
        });
      };
        ...
        >
          {({
            ...
            <form
              ...
              className="w-full max-w-xl bg-white rounded-lg shadow-2xl p-6"
            >
              <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="w-full md:w-full px-3 mb-6">
                  <button
                    ...
                    className="appearance-none block w-full bg-emerald-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-emerald-400 focus:outline-none focus:bg-white focus:border-gray-500"
                  >
                    Sign in
                  </button>
                </div>
