              ...
              <div className="details_wrapper">
                <div>{(balance || bill) && ((balance !== "0.00") || (bill !== "0.00") ) ? 
                      <>
                        ...
                        { balance && balance !== "0.00" ? <><h1 className="bill-amount-text"><span>Balance:</span> {`Rs. ${balance}`}</h1></> : ""}
                        { bill && bill !== "0.00" ? <><h1 className="bill-amount-text"><span>Bill Amount:</span> {`Rs. ${bill}`}</h1></>: ""}
